...
func testReadEntry(t *testing.T, line string, expected *entry) {
	t.Helper()
	...
	if expected != nil && *e != *expected {
		t.Fatalf("Expected entry to be %v, got %v", expected, e)
	}
}

func TestReadEntry(t *testing.T) {
	testReadEntry(t, "Allegoric Alaskians;Blithering Badgers;win", &entry{"Allegoric Alaskians", "Blithering Badgers", true})
	testReadEntry(t, "Allegoric Alaskians;Blithering Badgers;loss", &entry{"Blithering Badgers", "Allegoric Alaskians", true})
	testReadEntry(t, "Allegoric Alaskians;Blithering Badgers;draw", &entry{"Allegoric Alaskians", "Blithering Badgers", false})
	testReadEntry(t, "Allegoric Alaskians;Blithering Badgers;dr", nil)
}
